    ...
    <table class="min-w-full border-collapse text-sm text-gray-600">
      <thead>
        <tr class="bg-gradient-to-r from-green-500 to-emerald-500 text-white">
          ...
          <th class="px-6 py-3 text-left">Judul Galeri</th>
      ...
      <tbody>
        @forelse ($galeris as $index => $p)
          ...
          <td class="px-6 py-3 text-center flex justify-center gap-2">
            ...
            <form action="{{ route('admin.galeri.destroy', $p->id) }}" method="POST"
        ...
        @empty
          <tr>
            <td colspan="6" class="text-center py-6 text-gray-500">Belum ada data pendaftaran.</td>
          </tr>
        @endforelse
      </tbody>
    </table>
